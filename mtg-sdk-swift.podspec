#
#  Be sure to run `pod spec lint mtg-sdk-swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mario Meili"
  # s.authors            = { "Mario Meili" => "mario.meili@live.com" }
  # s.social_media_url   = "http://twitter.com/Mario Meili"
